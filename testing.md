...
##### Implementation
Using Bootstrap Toast system and the Django messages framework, users are notified of many different actions or errors across the website. The messages use appropriate levels and the toasts are styled using conventional colours based on those levels
##### Test
...
##### Implementation
Through checks in the views to and defensive programming
##### Test
